...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            ...
            {'grid_map/resolution': 0.05}, #地图分辨率 ####0.1
            ...
            {'grid_map/obstacles_inflation': 0.2},#障碍物膨胀半径，增加障碍物的安全边界。
            {'grid_map/local_map_margin': 10}, #本地地图边缘的安全距离。
            {'grid_map/ground_height': 0.08},#地面高度阈值，低于此高度的点会被认为是地面。
            ...
            {'grid_map/fy': fy},
            # depth filter
            {'grid_map/use_depth_filter': False}, #是否启用深度滤波。
            ...
            {'grid_map/virtual_ceil_height': 2.9}, #虚拟天花板高度，超过此高度的点会被忽略。
            {'grid_map/visualization_truncate_height': 1.8},# 可视化截断高度，超过此高度的点不会显示在可视化中。
