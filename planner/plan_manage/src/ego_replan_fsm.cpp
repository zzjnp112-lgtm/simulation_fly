...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(rclcpp::Node::SharedPtr &node)
  {
    ...
    ok_pub  =  node_->create_publisher<std_msgs::msg::Float64>("ego_ok",10);
  ...
  void EGOReplanFSM::execFSMCallback()
  {
    ...
    if (fsm_num == 100)
    {
      ...
      if (!have_target_)
        ...
        double ok =0;
        std_msgs::msg::Float64 msg;  // Include the necessary header if not already included
        msg.data = ok;
      ok_pub->publish(msg);
    ...
    case EXEC_TRAJ:
    {
      ...
      Eigen::Vector3d pos = info->position_traj_.evaluateDeBoorT(t_cur);
       ...
       double ok1 =1;
        std_msgs::msg::Float64 msg1;  // Include the necessary header if not already included
        msg1.data = ok1;
      ok_pub->publish(msg1);
